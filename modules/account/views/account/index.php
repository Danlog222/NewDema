...
<div class="application-index">
    ...
    <?= $dataProvider->sort->link('id') . ' | ' . $dataProvider->sort->link('master_id') . ' | ' . $dataProvider->sort->link('created_at') . ' | ' . $dataProvider->sort->link('date') . ' | ' . $dataProvider->sort->link('status_id'); ?>
